...
axios.defaults.withCredentials = true;
    ...
    useEffect(() => {
        axios.get(`https://bookstorebackend-mrqk3e92w-abel-girma-webits-projects.vercel.app/books/bookfind/${id}`)
            .then((res) => {
                console.log(res);
...
function postBookButton(e){
    ...
    axios.put(`https://bookstorebackend-mrqk3e92w-abel-girma-webits-projects.vercel.app/books/editbook/${id}` , EditedBookDetail)
